   ...
   <svg version="1.1" class="me-code" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <g id="FACE">
         ...
         <path class="st1" d="M633,290.3c0,0,21.7-23.2,29.8,0s10.8,32.2-7.2,99.5c0,0-7.3,28.2-31.9,21.7C618.3,398.8,627.6,338,633,290.3z
            "/>
         <path class="st2 eye eye-right" d="M419.1,320.3c8.4,0,16.6,0.4,24.3,1c-3.3-7.7-13.9-13.4-26.5-13.4c-12.8,0-23.6,5.9-26.7,13.9
            C399.8,320.8,409.4,320.3,419.1,320.3z"/>
         <path class="st2 eye eye-left" d="M535.1,320.3c-8.4,0-16.6,0.4-24.3,1c3.3-7.7,13.9-13.4,26.5-13.4c12.8,0,23.6,5.9,26.7,13.9
...
@mixin svgLineDraw {
   ...
   .st0, .st1, .st2, .st3, .st4, .st5, .st6, .st7, .st8, .st9, .st10, .st11, .s12 {
      fill:none;stroke:rgba(255,255,255,0.8);stroke-width:4;stroke-miterlimit:10;
   }
